...
public class WoodGolem extends AbstractGolem implements NeutralMob {
    ...
    public WoodGolem.Crackiness getCrackiness() {
        return WoodGolem.Crackiness.byFraction(this.getHealth() / this.getMaxHealth());
    }
    ...
    public static enum Crackiness {
        ...
        public static WoodGolem.Crackiness byFraction(float p_28902_) {
            for(WoodGolem.Crackiness woodgolem$crackiness : BY_DAMAGE) {
                if (p_28902_ < woodgolem$crackiness.fraction) {
                    return woodgolem$crackiness;
                }
            }
